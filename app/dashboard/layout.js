        ...
        <div className="relative flex min-h-[60vh] overflow-hidden mb-16">
          <div className="flex flex-col">
            <section className="z-50 flex flex-row justify-between items-center">
              ...
              <Avatar className="">
                <AvatarImage src={user?.user_metadata?.picture} alt={user?.user_metadata?.name} />
                <AvatarFallback>
                  <User className="h-8 w-8" />
                </AvatarFallback>
              </Avatar>
                <Signout className="bg-primary text-primary-foreground py-1 px-4 mr-7 border-0" size="sm"  />
              </div>
            </section>
